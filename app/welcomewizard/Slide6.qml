...
Component {
    ...
    Item {
        ...
        Label {
            ...
            text: i18n.tr("If you find any bugs or have any feature requests, let us know on our project page at %1").arg("<a href=\"https://github.com/ilyakooo0/upod/issues\">github.com</a>")
