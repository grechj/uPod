...
Component {
    ...
    Item {
        ...
        Label {
            ...
            // Hallo or Bonjour etc to symbolize the internationalization feature in upod.
        ...
        Label {
            ...
            text: i18n.tr("uPod is available in over 15 languages and is translated by the %1 community").arg("<a href=\"http://community.ubuntu.com/contribute/translations\">Ubuntu Translators</a>")
