    ...
    page: Page {
        ...
        PageHeader {
            ...
            extension: Sections {
                ...
                StyleHints {
                    selectedSectionColor: upod.appTheme.focusText
                }
                                ...
                                for (var i=0; i<episodeList.ViewItems.selectedIndices.length; i++) {
                                    ...
                                    if (!episodesModel.get(index).downloadedfile) {
                                        ...
                                        if (episodesModel.get(index).audiourl) {
                                            upod.downloadEpisode(episodesModel.get(index).image, episodesModel.get(index).name, episodesModel.get(index).guid, episodesModel.get(index).audiourl, false)
                                        } else {
        ...
        */
        ...
        ListView {
            ...
            Scrollbar {
                ...
                StyleHints { sliderColor: upod.appTheme.focusText }
            }
