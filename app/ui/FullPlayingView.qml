    ...
    Item {
        ...
        Row {
            ...
            AbstractButton {
                ...
                onClicked: {
                    if (player.position > 0) {
                        player.seek(player.position - upod.settings.skipBack * 1000);
                    }
                }
                ...
                Row {
                    ...
                    Label {
                        ...
                        text: i18n.tr("-%1s").arg(upod.settings.skipBack)
            ...
            AbstractButton {
                ...
                onClicked: {
                    if (player.position > 0) {
                        player.seek(player.position + upod.settings.skipForward * 1000);
                    }
                }
                ...
                Row {
                    ...
                    Label {
                        ...
                        // xgettext: no-c-format
                        text: i18n.tr("+%1s").arg(upod.settings.skipForward)
                        textSize: Label.XxSmall
                        color: upod.appTheme.baseText
